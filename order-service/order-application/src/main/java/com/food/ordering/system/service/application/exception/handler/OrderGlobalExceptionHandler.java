...
public class OrderGlobalExceptionHandler extends GlobalExceptionHandler {
    ...
    public ErrorDTO handleExcepiton(OrderDomainException orderDomainException) {
    ...
    public ErrorDTO handleExcepiton(OrderNotFoundException orderNotFoundException) {
