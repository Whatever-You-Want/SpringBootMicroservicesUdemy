...
public class OrderApplicationServiceTest {
    ...
    public void testCreateOrderWithWrongTotalPrice() {
        ...
        assertEquals("Total price: 250.00 is not equal to order itmes total price: 200.00!",
    ...
    public void testCreateOrderWithWrongProductPrice() {
        ...
        assertEquals("Order item price is: 60.00 is invalid for product: " + PRODUCT_ID + "!",
                orderDomainException.getMessage());
    }
    ...
    public void testCreateOrderWithNegativeTotalPrice() {
        CreateOrderCommand createOrderCommandWithNegativeTotalPrice = CreateOrderCommand.builder()
                .customerId(CUSTOMER_ID)
                .restaurantId(RESTAURANT_ID)
                .address(OrderAddress.builder()
                        .street("street_1")
                ...
                .items(List.of(OrderItem.builder()
                        ...
                        OrderItem.builder()
                                ...
                                .build()))
                .build();
        OrderDomainException resultException = assertThrows(OrderDomainException.class,
                () -> orderApplicationService.createOrder(createOrderCommandWithNegativeTotalPrice));

        assertEquals("Price must be greater than zero!", resultException.getMessage());
    }
}
