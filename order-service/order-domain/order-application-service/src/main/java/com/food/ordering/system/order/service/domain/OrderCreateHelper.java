...
public class OrderCreateHelper {
    ...
    public OrderCreatedEvent persistOrder(CreateOrderCommand createOrderCommand) {
        ...
        log.info("New order is created with id: {}", orderCreatedEvent.getOrder().getId().getValue());
    ...
    private Order saveOrder(Order order) {
        ...
        if (orderResult == null) {
            log.error("Order can not be saved");
            throw new OrderDomainException("An order can not be saved");
        }
